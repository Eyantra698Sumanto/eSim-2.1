...
Vdesign___024root::Vdesign___024root(const char* _vcname__)
...
void Vdesign___024root::__Vconfigure(Vdesign__Syms* _vlSymsp, bool first) {
...
void Vdesign___024root___settle__TOP__2(Vdesign___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vdesign__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdesign___024root___settle__TOP__2\n"); );
    // Variables
...
void Vdesign___024root___eval_settle(Vdesign___024root* vlSelf) {
    ...
    // Body
    Vdesign___024root___settle__TOP__2(vlSelf);
}

void Vdesign___024root___final(Vdesign___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vdesign__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdesign___024root___final\n"); );
}
