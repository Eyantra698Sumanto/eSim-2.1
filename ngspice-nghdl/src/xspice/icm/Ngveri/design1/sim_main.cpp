/* This is cfunc.mod file auto generated by gen_con_info.py
        ...
        int foo(int init,int count) 
        {
            ...
            static Vdesign1* design1[1024];
            count--;
            if (init==0) 
            {
                design1[count]=new Vdesign1{contextp};
            ...
            else
            {
				...
				printf("S=%d\n", design1[count] ->S);
				printf("Y=%d\n", design1[count] ->Y);
				design1[count]->D0 = arr2int(temp_D0, port_D0);
				design1[count]->D1 = arr2int(temp_D1, port_D1);
				design1[count]->S = arr2int(temp_S, port_S);
				design1[count]->eval();
				...
				printf("S=%d\n", design1[count] ->S);
				printf("Y=%d\n", design1[count] ->Y);
				int2arr(design1[count] -> Y, temp_Y, port_Y);
