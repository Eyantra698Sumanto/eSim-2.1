/* This is cfunc.mod file auto generated by gen_con_info.py
        ...
        int foo(int init,int count) 
        {
            ...
            else
            {
				...
				printf("clk=%d\n", dff5[count] ->clk);
				printf("q=%d\n", dff5[count] ->q);
				dff5[count]->d = arr2int(temp_d, port_d);
				dff5[count]->rstn = arr2int(temp_rstn, port_rstn);
				dff5[count]->clk = arr2int(temp_clk, port_clk);
				dff5[count]->eval();
				...
				printf("clk=%d\n", dff5[count] ->clk);
				printf("q=%d\n", dff5[count] ->q);
				int2arr(dff5[count] -> q, temp_q, port_q);
