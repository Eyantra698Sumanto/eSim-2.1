...
//_\SV
   module top(input wire clk, input wire reset,  output wire passed, output wire failed);    /* verilator lint_save */ /* verilator lint_off UNOPTFLAT */  bit [256:0] RW_rand_raw; bit [256+63:0] RW_rand_vect; pseudo_rand #(.WIDTH(257)) pseudo_rand (clk, reset, RW_rand_raw[256:0]); assign RW_rand_vect[256+63:0] = {RW_rand_raw[62:0], RW_rand_raw};  /* verilator lint_restore */  /* verilator lint_off WIDTH */ /* verilator lint_off UNOPTFLAT */   // (Expanded in Nav-TLV pane.)
`include "top_gen.sv" //_\TLV
   ...
   //  o CPU visualization
   //_|cpu
      `line 17 "riscvshelllib.tlv" 1   // Instantiated from top.tlv, 243 as: m4+imem(@1)
      ...
      `line 244 "top.tlv" 2
      `line 34 "riscvshelllib.tlv" 1   // Instantiated from top.tlv, 244 as: m4+rf(@2, @3)
         // Reg File
         //_@3
      ...
      `line 245 "top.tlv" 2
      `line 51 "riscvshelllib.tlv" 1   // Instantiated from top.tlv, 245 as: m4+dmem(@4)
         // Data Memory
         //_@4
   ...
   `line 64 "riscvshelllib.tlv" 1   // Instantiated from top.tlv, 247 as: m4+cpu_viz(@4)
      ...
      /*SV_plus*/
         ...
         assign instr_strs = '{ "(R) ADD r10,r0,r0                       ",  "(R) ADD r14,r10,r0                      ",  "(I) ADDI r12,r10,1010                   ",  "(R) ADD r13,r10,r0                      ",  "(R) ADD r14,r13,r14                     ",  "(I) ADDI r13,r13,1                      ",  "(B) BLT r13,r12,1111111111000           ",  "(R) ADD r10,r14,r0                      ",  "(S) SW r0,r10,10000                     ",  "(I) LW r17,r0,10000                     ",  "END                                     "};
      //_|cpuviz
         //_@1
   ...
   endgenerate //_\end_source    // For visualisation, argument should be at least equal to the last stage of CPU logic                       
   `line 248 "top.tlv" 2
//_\SV
   endmodule
