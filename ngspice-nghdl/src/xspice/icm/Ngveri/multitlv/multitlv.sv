...
`line 2 "multitlv.tlv" 0 //_\TLV_version 1d: tl-x.org, generated by SandPiper(TM) 1.11-2021/01/28-beta
`include "sp_default.vh" //_\SV
   ...
   module multitlv(input wire clk, input wire reset, input wire [31:0] cyc_cnt, output wire passed, output wire failed);    /* verilator lint_save */ /* verilator lint_off UNOPTFLAT */  bit [256:0] RW_rand_raw; bit [256+63:0] RW_rand_vect; pseudo_rand #(.WIDTH(257)) pseudo_rand (clk, reset, RW_rand_raw[256:0]); assign RW_rand_vect[256+63:0] = {RW_rand_raw[62:0], RW_rand_raw};  /* verilator lint_restore */  /* verilator lint_off WIDTH */ /* verilator lint_off UNOPTFLAT */
 
`include "multitlv_gen.sv" //_\TLV
   //_|mul
         
      // Random stimulus
      //_@0
         assign MUL_valid_a0[0:0] = RW_rand_vect[(0 + (0)) % 257 +: 1];
         assign MUL_aa_a0[34:0] = RW_rand_vect[(124 + (0)) % 257 +: 35];
         assign MUL_bb_a0[34:0] = RW_rand_vect[(248 + (0)) % 257 +: 35];
      ...
      //_?$valid
         ...
         //_@7
            ...
            // Sticky error flag.
            assign MUL_Error_a6 = reset ? 0 : MUL_Error_a7 || (MUL_mm_full_a7 != MUL_mm_a7);
            
            
            // Assert these to end simulation (before Makerchip cycle limit).
            assign passed = cyc_cnt > 40;
            assign failed = MUL_Error_a7; endgenerate
