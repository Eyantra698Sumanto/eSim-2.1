...
Vcounter::Vcounter(VerilatedContext* _vcontextp__, const char* _vcname__)
    : vlSymsp{new Vcounter__Syms(_vcontextp__, _vcname__, this)}
    , clk{vlSymsp->TOP.clk}
...
QData Vcounter___024root___change_request(Vcounter___024root* vlSelf);
#ifdef VL_DEBUG
...
static void _eval_initial_loop(Vcounter__Syms* __restrict vlSymsp) {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            Verilated::debug(1);
            __Vchange = Vcounter___024root___change_request(&(vlSymsp->TOP));
            Verilated::debug(__Vsaved_debug);
            VL_FATAL_MT("counter.v", 2, "",
...
VerilatedContext* Vcounter::contextp() const {
