...
void VConvert___024root___initial__TOP__1(VConvert___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VConvert__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VConvert___024root___initial__TOP__1\n"); );
    // Variables
    ...
    VL_PRINTF_MT("-Info: Convert.v:11: $dumpvar ignored, as Verilated without --trace\n");
...
void VConvert___024root___eval_initial(VConvert___024root* vlSelf) {
    ...
    // Body
    VConvert___024root___initial__TOP__1(vlSelf);
}

void VConvert___024root___combo__TOP__2(VConvert___024root* vlSelf);
