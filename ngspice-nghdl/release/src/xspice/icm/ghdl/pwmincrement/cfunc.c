...
extern void cm_pwmincrement(Mif_Private_t *);
...
void cm_pwmincrement(Mif_Private_t *mif_private) 
{
	...
	char temp_D[1024];
		...
		char command[1024];
		snprintf(command,1024,"/home/sumanto/ngspice-nghdl/src/xspice/icm/ghdl/pwmincrement/DUTghdl/start_server.sh %d %s &", sock_port, my_ip);
		system(command);
	}
	else
	{
