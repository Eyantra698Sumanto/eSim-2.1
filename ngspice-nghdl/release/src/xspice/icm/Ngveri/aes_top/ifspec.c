...
SPICEdev cm_aes_top_info = {
    .DEVpublic = {
        .name = "aes_top",
        .description = "Model generated from ghdl code aes_top.v",
        .terms = &val_terms,
