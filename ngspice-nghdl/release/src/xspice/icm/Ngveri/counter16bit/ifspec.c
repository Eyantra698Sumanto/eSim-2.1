...
/*
 * Structures for model: counter16bit
 *
...
extern void cm_counter16bit(Mif_Private_t *);
...
SPICEdev cm_counter16bit_info = {
    .DEVpublic = {
        .name = "counter16bit",
        .description = "Model generated from ghdl code counter16bit.v",
        .terms = &val_terms,
