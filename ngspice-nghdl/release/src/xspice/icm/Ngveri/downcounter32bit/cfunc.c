...
extern void cm_downcounter32bit(Mif_Private_t *);
/* This is cfunc.mod file auto generated by gen_con_info.py
        ...
        #include <math.h>
        #include <string.h>
        #include "sim_main_downcounter32bit.h"

        
void cm_downcounter32bit(Mif_Private_t *mif_private) 
{
    ...
    {   
        ...
        foodowncounter32bit(0,inst_count);
