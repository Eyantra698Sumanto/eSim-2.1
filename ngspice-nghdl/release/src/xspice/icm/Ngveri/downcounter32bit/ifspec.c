...
/*
 * Structures for model: downcounter32bit
 *
...
SPICEdev cm_downcounter32bit_info = {
    .DEVpublic = {
        .name = "downcounter32bit",
        .description = "Model generated from ghdl code downcounter32bit.v",
        .terms = &val_terms,
