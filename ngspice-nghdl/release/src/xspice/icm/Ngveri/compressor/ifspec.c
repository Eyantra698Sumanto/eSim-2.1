...
/*
 * Structures for model: compressor
 *
...
SPICEdev cm_compressor_info = {
    .DEVpublic = {
        .name = "compressor",
        .description = "Model generated from ghdl code compressor.v",
        .terms = &val_terms,
