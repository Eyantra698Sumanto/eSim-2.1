...
/*
 * Structures for model: us_sensor
 *
...
SPICEdev cm_us_sensor_info = {
    .DEVpublic = {
        .name = "us_sensor",
        .description = "Model generated from ghdl code us_sensor.v",
        .terms = &val_terms,
