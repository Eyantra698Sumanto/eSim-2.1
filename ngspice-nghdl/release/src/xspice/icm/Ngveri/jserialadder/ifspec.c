...
/*
 * Structures for model: jserialadder
 *
...
SPICEdev cm_jserialadder_info = {
    .DEVpublic = {
        .name = "jserialadder",
        .description = "Model generated from ghdl code jserialadder.v",
        .terms = &val_terms,
