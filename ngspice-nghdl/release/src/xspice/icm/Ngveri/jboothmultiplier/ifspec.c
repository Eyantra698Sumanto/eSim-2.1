...
/*
 * Structures for model: jboothmultiplier
 *
...
SPICEdev cm_jboothmultiplier_info = {
    .DEVpublic = {
        .name = "jboothmultiplier",
        .description = "Model generated from ghdl code jboothmultiplier.v",
        .terms = &val_terms,
