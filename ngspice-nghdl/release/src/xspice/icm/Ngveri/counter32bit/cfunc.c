...
extern void cm_counter32bit(Mif_Private_t *);
/* This is cfunc.mod file auto generated by gen_con_info.py
        ...
        #include <math.h>
        #include <string.h>
        #include "sim_main_counter32bit.h"

        
void cm_counter32bit(Mif_Private_t *mif_private) 
{
