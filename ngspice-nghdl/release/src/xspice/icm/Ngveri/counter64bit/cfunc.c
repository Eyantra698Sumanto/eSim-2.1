...
extern void cm_counter64bit(Mif_Private_t *);
/* This is cfunc.mod file auto generated by gen_con_info.py
        ...
        #include <math.h>
        #include <string.h>
        #include "sim_main_counter64bit.h"

        
void cm_counter64bit(Mif_Private_t *mif_private) 
{
    ...
    {   
		...
		cm_event_alloc(0,64*sizeof(Digital_State_t));
