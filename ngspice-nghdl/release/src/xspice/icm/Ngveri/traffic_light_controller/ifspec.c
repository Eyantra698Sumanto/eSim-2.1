...
/*
 * Structures for model: traffic_light_controller
 *
...
SPICEdev cm_traffic_light_controller_info = {
    .DEVpublic = {
        .name = "traffic_light_controller",
        .description = "Model generated from ghdl code traffic_light_controller.v",
        .terms = &val_terms,
        ...
        .cm_func = cm_traffic_light_controller,
        .num_conn = 6,
        .conn = MIFconnTable,
        .num_param = 4,
        .param = MIFparamTable,
