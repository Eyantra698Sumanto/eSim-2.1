...
/*
 * Structures for model: jfsmmoorewithoverlap
 *
...
SPICEdev cm_jfsmmoorewithoverlap_info = {
    .DEVpublic = {
        .name = "jfsmmoorewithoverlap",
        .description = "Model generated from ghdl code jfsmmoorewithoverlap.v",
        .terms = &val_terms,
        ...
        .cm_func = cm_jfsmmoorewithoverlap,
        .num_conn = 4,
        .conn = MIFconnTable,
        .num_param = 4,
        .param = MIFparamTable,
