...
/*
 * Structures for model: rom_using_file
 *
...
SPICEdev cm_rom_using_file_info = {
    .DEVpublic = {
        .name = "rom_using_file",
        .description = "Model generated from ghdl code rom_using_file.v",
        .terms = &val_terms,
