...
/*
 * Structures for model: jfsmmealywithoverlap
 *
...
SPICEdev cm_jfsmmealywithoverlap_info = {
    .DEVpublic = {
        .name = "jfsmmealywithoverlap",
        .description = "Model generated from ghdl code jfsmmealywithoverlap.v",
        .terms = &val_terms,
        ...
        .cm_func = cm_jfsmmealywithoverlap,
        .num_conn = 4,
        .conn = MIFconnTable,
        .num_param = 4,
        .param = MIFparamTable,
