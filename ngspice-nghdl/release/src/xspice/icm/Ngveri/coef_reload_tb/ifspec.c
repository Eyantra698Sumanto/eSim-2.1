...
/*
 * Structures for model: coef_reload_tb
 *
...
SPICEdev cm_coef_reload_tb_info = {
    .DEVpublic = {
        .name = "coef_reload_tb",
        .description = "Model generated from ghdl code coef_reload_tb.v",
        .terms = &val_terms,
