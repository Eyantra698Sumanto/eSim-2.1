...
/*
 * Structures for model: diff_io_top
 *
...
SPICEdev cm_diff_io_top_info = {
    .DEVpublic = {
        .name = "diff_io_top",
        .description = "Model generated from ghdl code diff_io_top.v",
        .terms = &val_terms,
