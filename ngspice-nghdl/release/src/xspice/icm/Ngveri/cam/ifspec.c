...
SPICEdev cm_cam_info = {
    .DEVpublic = {
        .name = "cam",
        .description = "Model generated from ghdl code cam.v",
        .terms = &val_terms,
