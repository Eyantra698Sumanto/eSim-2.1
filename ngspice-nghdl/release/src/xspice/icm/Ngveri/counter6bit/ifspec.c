...
/*
 * Structures for model: counter6bit
 *
...
extern void cm_counter6bit(Mif_Private_t *);
...
SPICEdev cm_counter6bit_info = {
    .DEVpublic = {
        .name = "counter6bit",
        .description = "Model generated from ghdl code counter6bit.v",
        .terms = &val_terms,
