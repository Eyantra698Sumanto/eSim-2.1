...
/*
 * Structures for model: counter8bit
 *
...
extern void cm_counter8bit(Mif_Private_t *);
...
SPICEdev cm_counter8bit_info = {
    .DEVpublic = {
        .name = "counter8bit",
        .description = "Model generated from ghdl code counter8bit.v",
        .terms = &val_terms,
