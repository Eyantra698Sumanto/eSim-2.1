...
/*
 * Structures for model: counter4bit
 *
...
extern void cm_counter4bit(Mif_Private_t *);
...
SPICEdev cm_counter4bit_info = {
    .DEVpublic = {
        .name = "counter4bit",
        .description = "Model generated from ghdl code counter4bit.v",
        .terms = &val_terms,
