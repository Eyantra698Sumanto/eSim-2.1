...
extern void cm_parallel_crc(Mif_Private_t *);
...
void cm_parallel_crc(Mif_Private_t *mif_private) 
{
    ...
    {   
        ...
        port_enable=mif_private->conn[2]->size;

        port_init=mif_private->conn[3]->size;

        port_data_in=mif_private->conn[4]->size;

        port_crc_out=mif_private->conn[5]->size;
    ...
    for(Ii=0;Ii<mif_private->conn[5]->size;Ii++)
    {
        ...
        {
            ((Digital_t*)(mif_private->conn[5]->port[Ii]->output.pvalue))->state = _op_crc_out[Ii];
            }
        else if(_op_crc_out[Ii] != _op_crc_out_old[Ii])
        {
            ((Digital_t*)(mif_private->conn[5]->port[Ii]->output.pvalue))->state = _op_crc_out[Ii];
            mif_private->conn[5]->port[Ii]->delay = ((_op_crc_out[Ii] == ZERO) ? mif_private->param[3]->element[0].rvalue : mif_private->param[2]->element[0].rvalue);
            }
        else
        {
