...
/*
 * Structures for model: counter3bit
 *
...
extern void cm_counter3bit(Mif_Private_t *);
...
SPICEdev cm_counter3bit_info = {
    .DEVpublic = {
        .name = "counter3bit",
        .description = "Model generated from ghdl code counter3bit.v",
        .terms = &val_terms,
