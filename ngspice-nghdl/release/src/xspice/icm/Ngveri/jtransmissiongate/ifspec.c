...
/*
 * Structures for model: jtransmissiongate
 *
...
SPICEdev cm_jtransmissiongate_info = {
    .DEVpublic = {
        .name = "jtransmissiongate",
        .description = "Model generated from ghdl code jtransmissiongate.v",
        .terms = &val_terms,
