...
extern void cm_jtransmissiongate(Mif_Private_t *);
/* This is cfunc.mod file auto generated by gen_con_info.py
        ...
        #include <math.h>
        #include <string.h>
        #include "sim_main_jtransmissiongate.h"

        
void cm_jtransmissiongate(Mif_Private_t *mif_private) 
{
    ...
    {   
        ...
        foojtransmissiongate(0,inst_count);
        /* Allocate storage for output ports and set the load for input ports */

        
        port_a=mif_private->conn[0]->size;

        port_control=mif_private->conn[1]->size;

        port_y=mif_private->conn[2]->size;
