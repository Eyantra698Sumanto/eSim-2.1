...
/*
 * Structures for model: ShiftRegister_PIPO
 *
...
SPICEdev cm_ShiftRegister_PIPO_info = {
    .DEVpublic = {
        .name = "ShiftRegister_PIPO",
        .description = "Model generated from ghdl code ShiftRegister_PIPO.v",
        .terms = &val_terms,
