...
/*
 * Structures for model: junsignedarraymultiplier
 *
...
SPICEdev cm_junsignedarraymultiplier_info = {
    .DEVpublic = {
        .name = "junsignedarraymultiplier",
        .description = "Model generated from ghdl code junsignedarraymultiplier.v",
        .terms = &val_terms,
        ...
        .cm_func = cm_junsignedarraymultiplier,
        .num_conn = 3,
        .conn = MIFconnTable,
        .num_param = 4,
        .param = MIFparamTable,
