...
/*
 * Structures for model: calculator
 *
...
SPICEdev cm_calculator_info = {
    .DEVpublic = {
        .name = "calculator",
        .description = "Model generated from ghdl code calculator.v",
        .terms = &val_terms,
