...
void VConvert___024root__traceChgSub0(VConvert___024root* vlSelf, VerilatedVcd* tracep);
...
void VConvert___024root__traceChgTop0(void* voidSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        VConvert___024root__traceChgSub0((&vlSymsp->TOP), tracep);
    }
}
...
void VConvert___024root__traceChgSub0(VConvert___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        tracep->chgBit(oldp+0,(vlSelf->o));
        tracep->chgBit(oldp+1,(vlSelf->i));
    }
}
