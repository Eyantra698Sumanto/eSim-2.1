...
VL_INLINE_OPT void Vm12___024root___combo__TOP__1(Vm12___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vm12__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vm12___024root___combo__TOP__1\n"); );
    // Body
...
void Vm12___024root___eval(Vm12___024root* vlSelf) {
    ...
    // Body
    Vm12___024root___combo__TOP__1(vlSelf);
}
