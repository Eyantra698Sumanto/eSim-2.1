...
VL_INLINE_OPT void VConvert___024root___sequent__TOP__1(VConvert___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VConvert__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VConvert___024root___sequent__TOP__1\n"); );
    // Body
...
void VConvert___024root___eval(VConvert___024root* vlSelf) {
    ...
    if ((((IData)(vlSelf->clk) & (~ (IData)(vlSelf->__Vclklast__TOP__clk))) 
        ...
        VConvert___024root___sequent__TOP__1(vlSelf);
    }
    // Final
